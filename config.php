...
//========================== Site Rules ==============================
$sc_location = 'CL Park';//enter a name for the self-check's location (e.g. 'East Branch') to track transactions in your SIP2 logs (in Polaris this is required and is the numeric organization ID) CL park, Self Access Center 5 - 6, Library Floor 1 - 4 etc.
...
$online_catalog_url = 'http://owpac.rmuti.ac.th'; 	/*leave blank if you don't have one or if your catalog does
