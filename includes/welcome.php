...
<div id="banner_title">
	<h2 style="color:#4d8b27">
		 <span><?php echo $welcome_title; ?></span>
 		<br />
...
<div id="banner" class="corners">
	...
	<h2>
		...
		<br />
		<span align="left" style="font-size:15px;color:#FCFCFC;font-style:italic;"><?php echo $welcome_screen_subtext;?></span>
	</h2>
</div>

<div class="cancel_button button" style="margin:100px auto 0 auto;"  id="cancel" title="selfcheck_button">
	<h1><?php echo $cancle_button; ?></h1>
</div>
<div class="thanks_button button" style="margin:100px auto 0 auto;">
	<h1><?php echo $thank_button; ?></h1>
</div>
