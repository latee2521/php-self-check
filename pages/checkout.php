...
<div id="cko_head">
	<h1>
		...
		<span style="font-size:15px;">&nbsp;&nbsp;<?php echo $library_name;?></span><br />&nbsp;<?php echo $module_name;?>
		<br /><br />
	</h1>
</div>
...
<div id="cko_wrapper">
	<div>
		...
		<a class="welcome">ยินดีต้อนรับ <?php echo substr($_SESSION['name'],0,strpos($_SESSION['name'],' '));?></a>
		<a class="tab">
	...
	<div id="cko_border">
		...
		<h2>รายการยืมทรัพยากรสารสนเทศ</h2>
		<table cellpadding="3" cellspacing="0" class="cko_column_head" align="center">
			<tbody>
				...
				<tr>
					<td>&nbsp;</td>
					<td style="width:80%">ทรัพยากรสารสนเทศ</td>
					<td>กำหนดส่งคืน</td>
				</tr>
...
$(document).ready(function() { 
	...
	$('#form').submit(function(){
		...
		$barcode=$('#barcode');
		//if(barcode.val() == '') return false; //New..!!
	...
	if (empty($_GET['barcode']) && (!is_numeric($_POST['barcode']) || strlen($_POST['barcode']) != 14)){ //if for some reason the item barcode in the url is empty fill in a bunk one
		$barcode='bunk_barcode';
		//$barcode='';
		//$response_message = 'invalid Barcode Please Insert Again';
	} else {
